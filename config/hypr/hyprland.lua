...
local menu        = "wofi --insensitive --allow-images --gtk-dark --show run"
...
hl.bind(mainMod .. "+ O", hl.dsp.exec_cmd("playerctl play-pause"))
hl.bind(mainMod .. "+ SHIFT + O", hl.dsp.exec_cmd("player"))
hl.bind(mainMod .. "+ U", hl.dsp.exec_cmd("playerctl previous"))
hl.bind(mainMod .. "+ I", hl.dsp.exec_cmd("playerctl next"))
hl.bind(mainMod .. "+ N", hl.dsp.exec_cmd("mic"))
hl.bind(mainMod .. "+ S", hl.dsp.exec_cmd("sound"))
hl.bind(mainMod .. "+ SHIFT + S", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 2%+"))
hl.bind(mainMod .. "+ SHIFT + A", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SOURCE@ 2%-"))
